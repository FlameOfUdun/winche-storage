...
internal sealed class NullArchive : IArchive
{
    ...
    public Task<bool> ObjectExistsAsync(string path, CancellationToken ct = default) => throw Missing();
    ...
    public Task CompleteMultipartUploadAsync(string path, string uploadId, CancellationToken ct = default) => throw Missing();
