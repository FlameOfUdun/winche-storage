...
public interface IArchive
{
    ...
    Task<bool> ObjectExistsAsync(string path, CancellationToken ct = default);
    ...
    Task CompleteMultipartUploadAsync(string path, string uploadId, CancellationToken ct = default);
